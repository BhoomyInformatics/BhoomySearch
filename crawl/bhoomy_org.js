// bhoomy_org.js - Crawls .org and .net domains
...
class Server {
    ...
    async loadSiteCount() {
        try {
            console.log('Loading site count for .org and .net domains...');
            ...
            console.log(`Found ${this.sitesCount} sites to crawl (.org domains)`);
        } catch (error) {
    ...
    async crawlerStart() {
        try {
            console.log('Starting crawler for .org domains...');
