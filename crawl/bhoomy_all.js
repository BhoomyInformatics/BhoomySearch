        ...
        try {
            ...
            while (true) {
                ...
                const rows = await con.query(`
                    ...
                    WHERE site_url NOT LIKE '%.in%'
                      AND site_url NOT LIKE '%.com%'
                      AND site_url NOT LIKE '%.info%'
                      AND site_url NOT LIKE '%.org%'
                      AND site_url NOT LIKE '%.net%'
                      AND site_url NOT LIKE '%.online%'
                      AND site_url NOT LIKE '%.store%'
